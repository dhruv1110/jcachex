...
const HomeComponent: React.FC = () => {
    ...
    return (
        <>
            <Helmet>
                <title>JCacheX - High Performance Java Caching Framework</title>
                <meta name="description" content="JCacheX is a modern, high-performance Java caching framework with advanced features like distributed caching, smart eviction strategies, and Spring Boot integration." />
                <meta name="keywords" content="Java, cache, caching, framework, performance, distributed, spring boot" />
            </Helmet>
