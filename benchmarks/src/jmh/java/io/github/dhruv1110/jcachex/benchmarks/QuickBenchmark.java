...
/**
 * Quick benchmark for fast validation of setup - only tests core libraries.
 */
...
public class QuickBenchmark {
    ...
    // Only essential cache implementations for quick testing
    ...
    public void setupTrial() {
        ...
        // Setup only essential cache implementations
        setupJCacheX();
        setupCaffeine();
        setupConcurrentMap();
    }
