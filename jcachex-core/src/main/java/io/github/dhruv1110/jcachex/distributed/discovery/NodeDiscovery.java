...
public interface NodeDiscovery {
    ...
    /**
     * Creates a Consul-based node discovery.
     *
     * @return Consul discovery builder
     */
    static ConsulDiscoveryBuilder consul() {
        return new ConsulDiscoveryBuilder();
    }

    /**
     * Creates an etcd-based node discovery.
     *
     * @return etcd discovery builder
     */
    static EtcdDiscoveryBuilder etcd() {
        return new EtcdDiscoveryBuilder();
    }

    /**
     * Creates a gossip protocol-based node discovery.
     *
     * @return gossip discovery builder
     */
    static GossipDiscoveryBuilder gossip() {
        return new GossipDiscoveryBuilder();
    }

    /**
     * Creates a static node discovery with predefined nodes.
     *
     * @return static discovery builder
     */
    static StaticDiscoveryBuilder staticNodes() {
        return new StaticDiscoveryBuilder();
    }

    /**
     * Creates a composite discovery that combines multiple strategies.
     *
     * @return composite discovery builder
     */
    static CompositeDiscoveryBuilder composite() {
        return new CompositeDiscoveryBuilder();
    }
    ...
    /**
     * Builder for Consul node discovery.
     */
    class ConsulDiscoveryBuilder extends BaseDiscoveryBuilder<ConsulDiscoveryBuilder> {
        protected String consulHost = "localhost:8500";
        protected String datacenter = "dc1";
        protected String token;
        protected boolean enableAcl = false;

        public ConsulDiscoveryBuilder consulHost(String consulHost) {
            this.consulHost = consulHost;
            return this;
        }

        public ConsulDiscoveryBuilder datacenter(String datacenter) {
            this.datacenter = datacenter;
            return this;
        }

        public ConsulDiscoveryBuilder token(String token) {
            this.token = token;
            return this;
        }

        public ConsulDiscoveryBuilder enableAcl(boolean enableAcl) {
        ...
        @Override
        public NodeDiscovery build() {
            return new ConsulNodeDiscovery(this);
        }
    }

    /**
     * Builder for etcd node discovery.
     */
    class EtcdDiscoveryBuilder extends BaseDiscoveryBuilder<EtcdDiscoveryBuilder> {
        private Collection<String> endpoints = Collections.singleton("http://localhost:2379");
        private String keyPrefix = "/jcachex/nodes/";
        private Duration leaseTtl = Duration.ofSeconds(30);

        public EtcdDiscoveryBuilder endpoints(Collection<String> endpoints) {
            this.endpoints = endpoints;
            return this;
        }

        public EtcdDiscoveryBuilder keyPrefix(String keyPrefix) {
            this.keyPrefix = keyPrefix;
            return this;
        }

        public EtcdDiscoveryBuilder leaseTtl(Duration leaseTtl) {
        ...
        @Override
        public NodeDiscovery build() {
            throw new UnsupportedOperationException("EtcdNodeDiscovery implementation not yet available");
        }
    }

    /**
     * Builder for gossip protocol node discovery.
     */
    class GossipDiscoveryBuilder extends BaseDiscoveryBuilder<GossipDiscoveryBuilder> {
        protected Collection<String> seedNodes = Collections.emptySet();
        protected Duration gossipInterval = Duration.ofSeconds(5);
        protected int gossipFanout = 3;
        protected Duration nodeTimeout = Duration.ofSeconds(60);

        public GossipDiscoveryBuilder seedNodes(String... seedNodes) {
            this.seedNodes = Arrays.asList(seedNodes);
            return this;
        }

        public GossipDiscoveryBuilder seedNodes(Collection<String> seedNodes) {
            this.seedNodes = seedNodes;
            return this;
        }

        public GossipDiscoveryBuilder gossipInterval(Duration gossipInterval) {
            this.gossipInterval = gossipInterval;
            return this;
        }

        public GossipDiscoveryBuilder gossipFanout(int gossipFanout) {
            this.gossipFanout = gossipFanout;
            return this;
        }

        public GossipDiscoveryBuilder nodeTimeout(Duration nodeTimeout) {
        ...
        @Override
        public NodeDiscovery build() {
            return new GossipNodeDiscovery(this);
        }
    }

    /**
     * Builder for static node discovery.
     */
    class StaticDiscoveryBuilder extends BaseDiscoveryBuilder<StaticDiscoveryBuilder> {
        private Collection<String> nodes = Collections.emptySet();

        public StaticDiscoveryBuilder nodes(String... nodes) {
            this.nodes = Arrays.asList(nodes);
            return this;
        }

        public StaticDiscoveryBuilder nodes(Collection<String> nodes) {
            this.nodes = nodes;
            return this;
        }
        ...
        @Override
        public NodeDiscovery build() {
            throw new UnsupportedOperationException("StaticNodeDiscovery implementation not yet available");
        }
    }

    /**
     * Builder for composite node discovery.
     */
    class CompositeDiscoveryBuilder extends BaseDiscoveryBuilder<CompositeDiscoveryBuilder> {
        private Collection<NodeDiscovery> discoveries = Collections.emptySet();

        public CompositeDiscoveryBuilder discoveries(NodeDiscovery... discoveries) {
            this.discoveries = Arrays.asList(discoveries);
            return this;
        }

        public CompositeDiscoveryBuilder discoveries(Collection<NodeDiscovery> discoveries) {
        ...
        @Override
        public NodeDiscovery build() {
            throw new UnsupportedOperationException("CompositeNodeDiscovery implementation not yet available");
        }
    }
}
